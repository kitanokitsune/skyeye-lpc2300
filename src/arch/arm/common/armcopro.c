...
// Anthony Lee removed 2006-08-27: below has one to replace this
#if 0
		 ...
		 ARMword instr, ARMword * value)
{
	...
	result = check_cp13_access (state, reg, CRm, BITS (21, 23),
				    BITS (5, 7));
	 ...
	 unsigned type ATTRIBUTE_UNUSED, ARMword instr, ARMword * value)
{
	...
	result = check_cp14_access (state, reg, BITS (0, 3), BITS (21, 23),
				    BITS (5, 7));
